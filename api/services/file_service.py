...
ALLOWED_EXTENSIONS = ['txt', 'markdown', 'md', 'pdf', 'html', 'htm', 'xlsx', 'doc', 'docx', 'csv', 'jpg', 'png', 'jpeg']
UNSTRUSTURED_ALLOWED_EXTENSIONS = ['txt', 'markdown', 'md', 'pdf', 'html', 'htm', 'xlsx','doc',
                                   'docx', 'csv', 'eml', 'msg', 'pptx', 'ppt', 'xml', 'jpg', 'png', 'jpeg']
